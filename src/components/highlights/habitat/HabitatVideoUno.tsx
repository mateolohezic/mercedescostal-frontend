    ...
    return (
        <div className="size-full relative">
            ...
            <video
                ...
                muted
                loop
                className="size-full aspect-video object-cover pointer-events-none select-none"
            >
                <source src="/assets/highlights/habitat/habitat_video_1.mp4" type="video/mp4" />
