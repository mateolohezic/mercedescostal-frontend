...
export const ProcesoCreativoBasaBasa = () => {
    ...
    return (
        <section className="my-24 lg:my-48 w-full grow px-4 lg:px-0 flex flex-col items-center font-truetypewritter">
            ...
            <Image src={basa_basa_proceso_8} alt="Basa Basa Mercedes Costal" sizes="(max-width: 768px) 100vw, 672px" className="mt-12 lg:-mt-12 w-full max-w-2xl object-contain relative z-10"/>
            ...
            <div className="mt-12 lg:mt-24 w-full max-w-4xl flex flex-col lg:flex-row gap-4">
                <div className="grow flex flex-col gap-4">
                    <Image src={basa_basa_proceso_1} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 480px" className="w-full lg:w-auto lg:h-80 object-contain"/>
                    <p className="text-lg text-left">{t('p3')}</p>
                    <Image src={basa_basa_proceso_9} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 480px" className="w-full object-contain"/>
                </div>
                <div className="w-full lg:w-80 shrink-0 flex flex-col gap-4">
                    <Image src={basa_basa_proceso_2} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 320px" className="w-full lg:w-auto lg:h-80 object-contain"/>
                    <Image src={basa_basa_proceso_3} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 320px" className="mt-20 lg:mt-0 w-full px-24 object-contain"/>
                </div>
            </div>
            ...
            <Image src={basa_basa_proceso_4} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 896px" className="mt-4 lg:mt-48 w-full max-w-4xl object-contain"/>
            ...
            <div className="mt-4 lg:mt-8 w-full max-w-4xl grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
                <Image src={basa_basa_proceso_6} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 448px" className="w-full object-contain"/>
                <Image src={basa_basa_proceso_7} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 448px" className="w-full object-contain"/>
            </div>
            ...
            <div className="mt-12 lg:mt-24 w-full grid grid-cols-1 lg:grid-cols-2 relative right-4">
                <Image src={basa_basa_proceso_5} alt="Basa Basa Mercedes Costal" sizes="(max-width: 1024px) 100vw, 50vw" className="w-full object-contain"/>
            </div>
        </section>
    )
}
