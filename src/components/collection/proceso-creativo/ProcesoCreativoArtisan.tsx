...
export const ProcesoCreativoArtisan = () => {
    return (
        <section className="my-24 lg:my-48 w-full grow flex flex-col items-center font-truetypewritter">
            ...
            <div className="mt-24 w-full max-w-3xl flex items-start gap-12">
                <div className="w-1/2 flex flex-col justify-start gap-24">
            ...
            <div className="mt-24 w-full max-w-3xl flex gap-12">
                <div className="w-1/2 flex flex-col justify-start gap-24">
                    <Image src={artisan_proceso_3} alt="Buen Diseño Mercedes Costal" className="w-full object-contain"/>
                    <div>
                        <p className="text-lg text-end">Es una colección que no ilustra, sino que evoca.</p>
                        <p className="mt-[1lh] text-lg text-end">No representa, sino que interpreta.</p>
                        <p className="mt-[1lh] text-lg text-end">Desde la fibra hasta el pigmento, desde la pampa extensa hasta el silencio de un taller, Artisans se escribe en capas.</p>
                        <p className="mt-[1lh] text-lg text-end">En cada una, un oficio: una pausa, un trazo, una respiración.</p>
                    </div>
                </div>
            ...
            <div className="mt-24 w-full flex justify-end overflow-x-hidden">
                <Image src={artisan_proceso_6} alt="Buen Diseño Mercedes Costal" className="w-2/3 object-contain relative left-4"/>
            </div>
        </section>
    )
}