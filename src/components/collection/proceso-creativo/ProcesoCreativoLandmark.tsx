    ...
    return (
        <section className="my-24 lg:my-48 w-full grow flex flex-col items-center font-truetypewritter">
            <div className="w-full max-w-3xl flex flex-col gap-4">
                <VideoProcesoCreativo video={"/assets/proceso_creativo/landmark/landmark_proceso_1.mp4"} className="w-full"/>
            ...
            <div className="mt-24 w-full max-w-3xl">
                <VideoProcesoCreativo video={"/assets/proceso_creativo/landmark/landmark_proceso_2.mp4"} className="w-full"/>
            </div>
            ...
            <div className="mt-24 w-full max-w-md">
                <VideoProcesoCreativo video={"/assets/proceso_creativo/landmark/landmark_proceso_3.mp4"} className="w-full"/>
            </div>
            <div className="mt-48 w-full max-w-4xl flex flex-col gap-12">
                <div className="w-full px-4 grid grid-cols-2 gap-3">
                    <VideoProcesoCreativo video={"/assets/proceso_creativo/landmark/landmark_proceso_4.mp4"} className="w-full"/>
            ...
            <div className="mt-12 w-full max-w-4xl">
                <VideoProcesoCreativo video={"/assets/proceso_creativo/landmark/landmark_proceso_5.mp4"} className="w-full"/>
            </div>
        </section>
    )
}