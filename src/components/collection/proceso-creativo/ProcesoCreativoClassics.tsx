        ...
        <section className="my-24 lg:my-48 w-full grow px-4 flex flex-col items-center font-truetypewritter">
            <div className="max-w-7xl flex flex-col lg:flex-row items-center lg:items-start gap-12">
                <div className="w-full lg:w-[45%] shrink-0 flex flex-col gap-12">
                    ...
                    <Image src={the_classics_proceso_3} alt="The Classics Mercedes Costal" sizes="(max-width: 1024px) 100vw, 576px" className="w-full object-contain"/>
                    <div>
                ...
                <div className="lg:pt-36 grow">
                    ...
                    <Image src={the_classics_proceso_1} alt="The Classics Mercedes Costal" sizes="(max-width: 1024px) 100vw, 704px" className="lg:mt-24 w-full object-contain"/>
                    <div className="mt-12 lg:mt-72 flex flex-col gap-4">
                        <Image src={the_classics_proceso_2} alt="The Classics Mercedes Costal" sizes="(max-width: 1024px) 100vw, 704px" className="w-full object-contain"/>
            ...
            <div className="mt-12 lg:mt-24 max-w-7xl flex flex-col gap-4">
                <Image src={the_classics_proceso_4} alt="The Classics Mercedes Costal" sizes="(max-width: 1280px) 100vw, 1280px" className="w-full aspect-[2] object-cover"/>
            ...
            <div className="mt-24 max-w-3xl flex flex-col items-center">
                ...
                <Image src={the_classics_proceso_5} alt="The Classics Mercedes Costal" sizes="(max-width: 1024px) 100vw, 768px" className="mt-24 w-full object-contain"/>
