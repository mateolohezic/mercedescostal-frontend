    ...
    return (
        <section className="my-24 lg:my-48 w-full grow flex flex-col items-center font-truetypewritter">
            <div className="max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-12">
                <Image src={vivero_proceso_1} alt="Vivero Mercedes Costal" sizes="(max-width: 1024px) 100vw, 512px" className="w-full object-contain"/>
            ...
            <div className="mt-12 lg:mt-24 max-w-3xl px-4 grid grid-cols-1 lg:grid-cols-2 gap-12">
                <div className="w-full flex flex-col gap-24">
                    ...
                    <div className="px-12 flex flex-col gap-4">
                        <Image src={vivero_proceso_2} alt="Vivero Mercedes Costal" sizes="(max-width: 1024px) 100vw, 300px" className="w-full object-contain"/>
                        <p className="text-lg">{t('p5')}</p>
                        <Image src={vivero_proceso_3} alt="Vivero Mercedes Costal" sizes="(max-width: 1024px) 100vw, 300px" className="w-full object-contain"/>
                    </div>
                </div>
            ...
            <div className="mt-12 lg:mt-24 max-w-3xl flex flex-col gap-8">
                <Image src={vivero_proceso_4} alt="Vivero Mercedes Costal" sizes="(max-width: 1024px) 100vw, 768px" className="w-full object-contain"/>
            ...
            <div className="mt-4 lg:mt-12 w-full max-w-4xl grid grid-cols-2 gap-4 lg:gap-12">
                <Image src={vivero_proceso_5} alt="Vivero Mercedes Costal" sizes="(max-width: 768px) 50vw, 448px" className="w-full object-contain"/>
            ...
            <div className="mt-12 lg:mt-24 w-full max-w-4xl grid grid-cols-2 gap-1 lg:gap-12">
                ...
                <Image src={vivero_proceso_6} alt="Vivero Mercedes Costal" sizes="(max-width: 768px) 50vw, 448px" className="w-full object-contain"/>
            ...
            <div className="mt-12 lg:mt-24 w-full max-w-5xl grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-8">
                <div className="w-full flex flex-col gap-4 lg:gap-8">
                    ...
                    <Image src={vivero_proceso_8} alt="Vivero Mercedes Costal" sizes="(max-width: 1024px) 100vw, 512px" className="w-full object-contain"/>
                </div>
                <div className="w-full flex flex-col gap-4 lg:gap-8 text-lg">
                    ...
                    <div className="w-full grow">
                        <Image src={vivero_proceso_7} alt="Vivero Mercedes Costal" sizes="(max-width: 1024px) 100vw, 512px" className="w-full object-contain"/>
                    </div>
