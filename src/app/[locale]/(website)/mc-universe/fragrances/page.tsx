    ...
    return (
        <main className="my-24 lg:my-48 w-full grow flex flex-col items-center font-truetypewritter">
            <section className="w-full px-4 xl:px-12 flex flex-col gap-8">
                ...
                <Image src={portada} priority alt="Portada Fragrances Mercedes Costal" sizes="100vw" className="w-full aspect-video object-cover"/>
            </section>
            ...
            <section className="mt-8 lg:mt-12 w-full max-w-5xl 2xl:max-w-7xl px-4 md:px-0">
                <div className="w-full grid grid-cols-2 lg:gap-8">
                    <Image src={fragrances_16} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="w-full"/>
                    <Image src={fragrances_15} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="w-full"/>
                    <Image src={fragrances_18} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="w-full"/>
                    <Image src={fragrances_17} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="w-full"/>
                    <Image src={fragrances_1} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4] object-[50%_90%]"/>
                    <Image src={fragrances_2} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4] object-[50%_100%]"/>
                    <Image src={fragrances_3} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_4} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_5} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_6} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4] object-[50%_100%]"/>
                    <Image src={fragrances_7} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_8} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_9} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_10} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4] object-[50%_100%]"/>
                    <Image src={fragrances_11} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_12} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_13} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                    <Image src={fragrances_14} alt="Fragrances Mercedes Costal" sizes="(max-width: 1280px) 50vw, 640px" className="size-full object-cover aspect-[3/4]"/>
                </div>
            </section>
        </main>
    );
