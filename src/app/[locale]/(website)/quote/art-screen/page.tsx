...
export async function generateMetadata({ params }: { params: Promise<{ locale: string }> }) {
    ...
    const t = await getTranslations({ locale, namespace: 'metadata.quoteArtScreen' });
    ...
    return {
        ...
        alternates: {
            canonical: '/quote/art-screen',
            languages: {
                'es': '/quote/art-screen',
                'en': '/en/quote/art-screen',
            },
        },
        openGraph: {
...
export default async function QuoteArtScreenPage({ searchParams }: Props) {
