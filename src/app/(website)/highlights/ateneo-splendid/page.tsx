    ...
    return (
        <main className="my-24 lg:my-40 w-full flex flex-col items-center font-truetypewritter">
            <section className="w-full max-w-7xl px-4 xl:px-0 flex flex-col gap-8">
                ...
                <Image src={portada} alt="Portada Ateneo Splendid Mercedes Costal" className="w-full lg:w-auto lg:h-96 object-cover"/>
            </section>
            ...
            <section className="mt-24 lg:mt-48 w-full max-w-7xl px-4 xl:px-0">
                <Image src={ateneo_splendid_8} alt="Ateneo Splendid Mercedes Costal" className="w-full object-contain"/>
            </section>
            <section className="mt-12 lg:mt-24 w-full max-w-3xl flex flex-col justify-center items-center gap-1 lg:gap-4 px-4 md:px-0">
