...
export default function ManantialesPopupPage() {
    return (
        <main className="my-24 lg:my-48 w-full grow flex flex-col items-center font-truetypewritter">
            ...
            <section className="mt-12 lg:mt-24 w-full max-w-5xl 2xl:max-w-7xl flex justify-start px-4 md:px-0">
                <Image src={manantiales_1} alt="Manantiales Pop Up Mercedes Costal" className="w-full max-w-2xl h-auto object-contain"/>
            </section>
            <section className="mt-4 lg:mt-24 w-full max-w-5xl 2xl:max-w-7xl flex flex-col items-end gap-2 lg:gap-8 px-4 md:px-0">
            ...
            <section className="mt-24 w-full max-w-5xl 2xl:max-w-7xl flex justify-center px-4 md:px-0">
                <Image src={manantiales_3} alt="Manantiales Pop Up Mercedes Costal" className="w-full h-auto object-contain"/>
            </section>
            <section className="mt-4 lg:mt-12 w-full max-w-5xl 2xl:max-w-7xl flex flex-col justify-center lg:justify-end items-center lg:items-end gap-24 lg:gap-8 px-4 md:px-0">
