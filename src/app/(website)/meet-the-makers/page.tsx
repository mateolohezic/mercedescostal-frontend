    ...
    return (
        <main className="my-24 lg:my-32 w-full grow flex flex-col items-center font-truetypewritter">
            ...
            <section className="mt-24 lg:mt-48 w-full max-w-5xl 2xl:max-w-7xl px-4 xl:px-0 flex flex-col items-center gap-24">
                ...
                <p className="w-full max-w-4xl text-center lg:text-xl tracking-widest">En MERCEDES COSTAL logramos conectar a las personas con el mundo del diseño, el arte y la historia a través de la creación, producción y venta de wallpapers para generar una experiencia inmersiva en el observador.</p>
            </section>
            ...
            <section className="my-24 lg:my-64 w-full max-w-5xl 2xl:max-w-7xl px-4 xl:px-0 flex flex-col lg:flex-row justify-center lg:justify-between items-start gap-8 lg:gap-4">
                <div className="grow max-w-2xl tracking-widest lg:text-xl flex flex-col justify-center items-center gap-8">
